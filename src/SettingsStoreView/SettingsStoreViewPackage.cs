...
namespace SettingsStoreView
{
    ...
    public sealed class SettingsStoreViewPackage : AsyncPackage
    {
        ...
        /// </summary>
        public SettingsStoreViewPackage()
        {
        ...
        {
            Telemetry.Client.TrackEvent(Telemetry.CreateInitializeTelemetryItem(nameof(SettingsStoreViewPackage) + "." + nameof(InitializeAsync)));

            // When initialized asynchronously, the current thread may be a background thread at this point.
            // Do any initialization that requires the UI thread after switching to the UI thread.
            await JoinableTaskFactory.SwitchToMainThreadAsync(cancellationToken);
            await SettingsStoreViewToolWindowCommand.InitializeAsync(this);
        }
