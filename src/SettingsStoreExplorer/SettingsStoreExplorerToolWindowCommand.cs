...
namespace SettingsStoreExplorer
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class SettingsStoreExplorerToolWindowCommand
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SettingsStoreExplorerToolWindowCommand"/> class.
        ...
        private SettingsStoreExplorerToolWindowCommand(AsyncPackage package, OleMenuCommandService commandService)
        {
            ...
            var menuItem = new MenuCommand(Execute, SettingsStoreExplorerToolWindowCommandId);
        ...
        /// </summary>
        public static SettingsStoreExplorerToolWindowCommand Instance { get; private set; }
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            var window = _package.FindToolWindow(typeof(SettingsStoreExplorerToolWindow), 0, true);
